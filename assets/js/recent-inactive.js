// =============================================
// RECENT INACTIVE PLAYERS PAGE FUNCTIONS
// =============================================
...
function renderTable(data) {
  ...
  const players = data.recentInactivePlayers || [];
  const totalPlayers = players.length;
  const currentPage = tableState.playerTables['RecentInactive'].page;
  const paginatedPlayers = getPaginatedPlayers(players, currentPage, PLAYERS_PER_PAGE);
  
  if (!players.length) {
    tbl.innerHTML = `<div class='table-container' style='text-align: center; padding: 2rem;'><p>No recent inactive players found.</p></div>`;
    return;
  }
  ...
  let html = `
    <div class="table-container">
      <div class="table-header">
        <h3 class="table-title">Recent Inactive Players (3-4 days) - ${totalPlayers} total</h3>
...
function changePage(page) {
  tableState.playerTables['RecentInactive'].page = page;
